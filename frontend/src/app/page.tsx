  ...
  return (
    <main className="w-full">
      ...
      <section className="p-[5%] flex flex-col items-center justify-center">
        <h3 className="text-main-green mb-6">Services we provide</h3>
      ...
      <section className="p-[5%] flex flex-col items-center justify-center">
        <h3 className="text-main-green mb-6">Meet our team members</h3>
        <p className="text-accent-black mb-12">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. <br />
          Dolores neque consequuntur asperiores magni unde.
        </p>
        <div className="w-full grid gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          {team_data.map((member, i) => (
            <div
              className="text-center flex flex-col py-4 px-6 md:py-8 bg-white rounded-3xl items-center justify-between gap-4"
              key={i}
            >
              <Image
                alt="member image"
              ...
              />
              <h3 className="text-main-green">{member.name}</h3>
              <h4 className="text-base md:text-lg font-medium text-[#333333]">
                {member.title}
              </h4>
      ...
      <section className="p-[5%] flex flex-col items-center justify-center">
        <h3 className="text-main-green mb-6">Testimonial</h3>
        <p className="text-accent-black mb-12">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. <br />
          Dolores neque consequuntur asperiores magni unde.
        </p>
        <div className="w-full grid gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          {testimonials.map((testimonial, i) => (
            <div
              className="flex flex-col p-6 md:p-8 bg-white rounded-3xl items-start justify-between gap-4 md:gap-6"
              key={i}
            >
              <Image
              ...
              />
              <h4 className="text-lg md:text-[22px] font-bold text-main-black">
                {testimonial.testimonial}
              </h4>
              <p className="text-accent-black">{testimonial.info}</p>
              <div className="font-semibold text-main-green mt-2">
                <p className="text-main-green">{testimonial.name}</p>
                <p className="text-accent-black">{testimonial.title}</p>
              </div>
            </div>
          ))}
        </div>
